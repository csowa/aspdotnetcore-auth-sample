...
builder.Services.AddAuthentication(sharedOptions =>
    ...
    .AddWsFederation(async options =>
    {
        ...
        await SetupTokenValidationParametersAsync(options);
...
/// </remarks>
static async Task SetupTokenValidationParametersAsync(WsFederationOptions options)
{
